...
print(array.argmax())
minimo=array.min()
print(f"valor minimo es {minimo}")
print(array.argmin())
...
print(matriz[:2])#dos primera fora
print(matriz[1][2])#segunda fila y tercera columna
print(matriz[:,1])
print(matriz[:,:1])
print(matriz)
print(matriz+10)
...
print(lista)
print("mostrando lista modificada")
